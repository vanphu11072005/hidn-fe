...
export default function QuestionsHeader({
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        const value = costs?.questions ?? null;
  ...
  return (
    <div className="sticky top-0 z-10 bg-white dark:bg-[#212121]">
      <div
        className={`max-w-4xl mx-auto px-4 transition-all 
        duration-200`}
      >
        <div 
          className="mx-auto max-w-4xl w-full border-b 
          border-b-[1px] border-gray-200 dark:border-gray-700 pb-4"
        >
          <div className="flex items-start justify-between mb-2">
            ...
            <div className="flex items-center">
              <Tooltip content={config.helpText} position="left">
                <HelpCircle
                  className="w-6 h-6 text-gray-700 cursor-help dark:text-white 
                ...
                >
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-3 h-9 
                      ...
                      bg-transparent text-sm text-gray-700 dark:text-gray-400 
                      hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors 
                      duration-150"
                    title="Thay đổi cài đặt câu hỏi"
                  >
                    <span 
                      className="text-sm font-medium 
                      text-gray-700 dark:text-white"
                    >
                      {currentTypeLabel} · {questionCount} câu
                    </span>
                    <ChevronDown 
