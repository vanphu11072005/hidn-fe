...
import { Eye, EyeOff, Mail, Lock, ChevronLeft, Loader2, AlertCircle, LogIn } from 'lucide-react';
...
export default function LoginPage() {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (type !== 'checkbox' && value !== oldValue) {
      setFormError('');
      clearError();
    }
  };
  ...
  return (
    <div className="min-h-screen relative flex items-center 
      ...
      {/* Top-left short Back to Home (icon + short text on desktop) */}
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-br 
          from-blue-900/90 via-purple-900/85 to-pink-900/90">
        </div>
      </div>
      ...
      >
        ...
        {/* (moved) Back to Home link now in top-left for compact layout */}
      </div>
